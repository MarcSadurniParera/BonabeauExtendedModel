...
dimension longvec(0:4) !Study for five system sizes

!Common parameters of the model
common/parameters/fraction
fraction=0.01d0

longvec=[25,45,65,95,120] !System sizes to explore
eta=5.0d0
...
open (30,file='fitnessagents.dat')
open (40,file='fitnessagents2.dat')
...
!White spaces between different system sizes.
write(30,*)
write(30,*)
write(40,*)
write(40,*)
